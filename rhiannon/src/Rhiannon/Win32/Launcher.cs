...
namespace Rhiannon.Win32
{
	...
	{
		public static Process Launch(int requiredSessionId, string fileName, string args, StringDictionary environmentVariables)
		{
		...
		public static Process LaunchInSpecialSession(int sessionId, string fileName, string args, StringDictionary environmentVariables)
		{
			Process process;
			...
			try
			{
				...
				if (NativeMethods.CreateProcessAsUser(userToken, fileName, args, IntPtr.Zero, IntPtr.Zero, false, creationFlags, customEnvironment, null, ref startupInfo, out processInformation))
				{
