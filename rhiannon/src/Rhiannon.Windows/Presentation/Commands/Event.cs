...
namespace Rhiannon.Windows.Presentation.Commands
{
	public static class Event
	{
		...
		private static readonly DependencyProperty EventCommandBehaviorProperty = DependencyProperty.RegisterAttached("EventCommandBehavior", typeof(ControlEventCommandBehavior), typeof(Event), null);
        public static readonly DependencyProperty EventNameProperty = DependencyProperty.RegisterAttached("EventName", typeof(string), typeof(Event), new PropertyMetadata(OnEventNameChanged));
        public static readonly DependencyProperty CommandProperty = DependencyProperty.RegisterAttached("Command", typeof(ICommand), typeof(Event), new PropertyMetadata(OnCommandChanged));
        public static readonly DependencyProperty CommandParameterProperty = DependencyProperty.RegisterAttached("CommandParameter", typeof(object), typeof(Event), new PropertyMetadata(OnCommandParameterPropertyChanged));
        ...
        private static void OnCommandParameterPropertyChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
		{
			Control control = dependencyObject as Control;
			if (control != null)
			{
		...
		private static ControlEventCommandBehavior GetOrCreateBehavior(Control control)
		{
			...
			ControlEventCommandBehavior behavior = (ControlEventCommandBehavior)control.GetValue(EventCommandBehaviorProperty);
			if (behavior == null)
			{
