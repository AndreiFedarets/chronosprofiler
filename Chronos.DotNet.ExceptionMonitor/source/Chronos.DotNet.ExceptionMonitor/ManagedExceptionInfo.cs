...
{
    [Serializable]
    public sealed class ManagedExceptionInfo : UnitBase
    {
        ...
        private ManagedExceptionNativeInfo ExceptionNativeInfo
        {
            get { return (ManagedExceptionNativeInfo)NativeUnit; }
        }
