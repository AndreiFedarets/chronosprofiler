...
#ifdef CHRONOS_JAVA_BASICPROFILER_EXPORT_API
#define CHRONOS_JAVA_BASICPROFILER_API __declspec(dllexport) 
#else
#define CHRONOS_JAVA_BASICPROFILER_API __declspec(dllimport) 
#endif
...
//
//// ==================================================================================================================================================
//				struct CHRONOS_JAVA_BASICPROFILER_API AssemblyInfo : public BasicUnitBase<Reflection::AssemblyMetadata>
//				{
//					public:
//						AssemblyInfo();
//						void PrepareClose();
...
//
//// ==================================================================================================================================================
//				struct CHRONOS_JAVA_BASICPROFILER_API ModuleInfo : public BasicUnitBase<Reflection::ModuleMetadata>
//				{
//					public:
//						ModuleInfo();
//						void PrepareClose();
...
//
//// ==================================================================================================================================================
//				struct CHRONOS_JAVA_BASICPROFILER_API ClassInfo : public BasicUnitBase<Reflection::TypeMetadata>
//				{
//					public:
//						ClassInfo();
//						void PrepareClose();
...
//
//// ==================================================================================================================================================
//				struct CHRONOS_JAVA_BASICPROFILER_API FunctionInfo : public BasicUnitBase<Reflection::MethodMetadata>
//				{
//					public:
//						FunctionInfo();
//						void PrepareClose();
...
//		
//// ==================================================================================================================================================
//				class CHRONOS_JAVA_BASICPROFILER_API AssemblyCollection : public BasicUnitCollectionBase<AssemblyInfo>
//				{
//					public:
//						const static __guid ServiceToken;
//					protected:
...
//
//// ==================================================================================================================================================
//				class CHRONOS_JAVA_BASICPROFILER_API ModuleCollection : public BasicUnitCollectionBase<ModuleInfo>
//				{
//					public:
//						const static __guid ServiceToken;
//					protected:
...
//
//// ==================================================================================================================================================
//				class CHRONOS_JAVA_BASICPROFILER_API ClassCollection : public BasicUnitCollectionBase<ClassInfo>
//				{
//					public:
//						const static __guid ServiceToken;
//					protected:
...
//
//// ==================================================================================================================================================
//				class CHRONOS_JAVA_BASICPROFILER_API FunctionCollection : public BasicUnitCollectionBase<FunctionInfo>
//				{
//					public:
//						const static __guid ServiceToken;
//					protected:
...
//
// ==================================================================================================================================================
				class CHRONOS_JAVA_BASICPROFILER_API ProfilingTypeAdapter : public IProfilingTypeAdapter
				{
					public:
